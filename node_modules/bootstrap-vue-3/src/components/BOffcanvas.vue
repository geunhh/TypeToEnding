<template>
  <div ref="element" class="offcanvas" :class="computedClasses" tabindex="-1" aria-labelledby="offcanvasLabel"
    :data-bs-backdrop="backdropBoolean" :data-bs-scroll="bodyScrollingBoolean">
    <div v-if="!noHeaderBoolean" class="offcanvas-header">
      <slot name="header" v-bind="{ visible: modelValueBoolean, placement, hide }">
        ...
        <b-close-button v-if="!noHeaderCloseBoolean" class="text-reset" data-bs-dismiss="offcanvas"
