<template>
  <div ref="parent" :class="computedClasses" class="btn-group">
    <b-button :id="computedId" :variant="splitVariant || variant" :size="size" :class="buttonClasses"
    ...
    <ul class="dropdown-menu" :class="dropdownMenuClasses" :aria-labelledby="computedId" :role="role">
      <slot />
    </ul>
  </div>
</template>
