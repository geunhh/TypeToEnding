...
|----------|-------------------|-----------------------------------|
| **김근휘**   | **1번 팀장**   | 영화 추천 알고리즘, API 설계 및 관리, 커스텀 영화 |
| **권동환**   | **2번 팀장**   | 프로젝트 아이디어 구상, 유저 정보 관련 기능 담당, 전체적인 UI/UX 통일 |
...
## 8. 🌟 기타 (느낀점, 후기 등)
### 팀원들의 소감
- 김근휘: "영화 추천 알고리즘 구현 과정이 도전적이었지만, 데이터 분석과 AI 기술이 어떻게 접목되는지 배울 수 있는 좋은 기회였습니다."
- 권동환: "디자인 작업이 많아 고되었지만, 사용자 경험을 위한 인터페이스 제작에 보람을 느꼈습니다."
### 향후 계획
1. 사용자 경험 강화를 위한 추가 인터랙션 기능 개발.
2. 더 많은 영화 데이터와 TMDB API 확장을 통한 추천 품질 개선.
3. AI 성능 향상을 위해 GPT 프롬프트 최적화 진행.
